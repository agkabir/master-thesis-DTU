...
missing_data_point = np.ndarray(shape=(512,512), dtype='uint8')
...
for period in periods:
    ...
    if os.path.isdir(raw_path)==False:
        ...
        mmf = np.memmap(processed_path+'\\' +period +'.array', dtype='uint8', mode='w+', shape=(dimension,512,512))
